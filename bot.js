...
support_bot.command("Наша команда",async(ctx)=>{
...
support_bot.command("Список команд",async(ctx)=>{
    ctx.sendMessage("/Вбиверы - показывает всех актуальных вбиверов ‼️ \n\n/Наша команда - показывает актуальный состав команды ‼️ \n\n/Мануалы - здесь можно прочитать всё мануалы ‼️ \n\n/Бот - актуальный бот для воркеров ‼️ \n\n/Список команд - показывает всё команды, которые доступны ‼️")
})
